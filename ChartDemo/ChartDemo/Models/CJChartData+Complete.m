...
- (void)completeChartDataByData:(NSArray *)datas withDateBegin:(NSDate *)dateBegin dateEnd:(NSDate *)dateEnd {
    ...
    NSDate *showDateBegin = [dateBegin dateDistances:-self.xPlaceholderUnitCountAtBegin type:eDistanceDay];
    NSDate *showDateEnd = [dateEnd dateDistances:self.xPlaceholderUnitCountAtLast type:eDistanceDay];
